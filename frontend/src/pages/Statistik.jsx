      ...
      <main>
        <div className="eins">
          ...
          <div className="templang-image-box" id="templang">
            <span className="templang-image-text">
              Hier findest du die Rangliste der 10 besten Spieler, basierend auf
              ihren herausragenden Leistungen und beeindruckenden Statistiken.
            </span>
          </div>
        </div>
        <div className="zwei">
